...
?>
    ...
    <td><a href = "registertable1.php?rn=<?php echo $row['Username'];?>">delete</a>
	<td> <fieldset>
                    <br>
                    <select name="update" id="update" size="1">
                    <option>Applied</option>
                    <option>Verification 1</option>
                    <option>verification2</option>
